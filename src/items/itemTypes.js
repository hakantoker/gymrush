...
export const ITEM_TYPES = {
  ...
  TREADMILL: {
    ...
    label:             'Treadmill',
    color:             0x3A6EA5,
    effects:           { cardio: 5, endurance: 4, legs: 2 },
    maxCapacity:       1,
    maxQueueSize:      3,
    useDuration:       18,
  ...
  BENCH: {
    ...
    label:             'Weight Bench',
    color:             0x8B3A3A,
    effects:           { chest: 5, shoulders: 3, arms: 2, core: 1 },
    maxCapacity:       1,
    maxQueueSize:      2,
    useDuration:       22,
  ...
  BIKE: {
    ...
    color:             0x2E7D32,
    effects:           { cardio: 4, endurance: 3, legs: 5, glutes: 2 },
    maxCapacity:       1,
    maxQueueSize:      2,
    useDuration:       14,
  ...
  DUMBBELL_RACK: {
    ...
    label:             'Dumbbell Rack',
    color:             0x5D4037,
    effects:           { arms: 5, shoulders: 3, back: 2, chest: 2 },
    maxCapacity:       1,
    maxQueueSize:      3,
    useDuration:       14,
